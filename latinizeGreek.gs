/*
Source code: https://gist.github.com/kostasx/7516158
The function converts all the Greek caracters in a string following the dictionary in 'from' 'to'
*/

function latinizeGreek(str) {
